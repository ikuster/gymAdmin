...
namespace gymAdmin
{
    public partial class AzurirajKlijent : Form
    {
        ...
        private void AzurirajKlijent_HelpRequested(object sender, HelpEventArgs hlpevent)
        {
            string RunningPath = AppDomain.CurrentDomain.BaseDirectory;
            string FileName = string.Format("{0}Resources\\helpAzurirajKlijent.html", Path.GetFullPath(Path.Combine(RunningPath, @"..\..\")));
