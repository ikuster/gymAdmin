...
namespace gymAdmin
{
    public partial class Mjerenja : Form
    {
        ...
        private void Mjerenja_HelpRequested(object sender, HelpEventArgs hlpevent)
        {
            string RunningPath = AppDomain.CurrentDomain.BaseDirectory;
            string FileName = string.Format("{0}Resources\\helpMjerenja.html", Path.GetFullPath(Path.Combine(RunningPath, @"..\..\")));
