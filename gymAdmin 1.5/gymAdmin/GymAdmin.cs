...
namespace gymAdmin
{
    public partial class GymAdmin : Form
    {
        ...
        private void PanelKlijenti_HelpRequested(object sender, HelpEventArgs hlpevent)
        {
            string RunningPath = AppDomain.CurrentDomain.BaseDirectory;
            string FileName = string.Format("{0}Resources\\helpKlijent.html", Path.GetFullPath(Path.Combine(RunningPath, @"..\..\")));
            Help.ShowHelp(this, FileName);
        }

        private void PanelClanarine_HelpRequested(object sender, HelpEventArgs hlpevent)
        {
            string RunningPath = AppDomain.CurrentDomain.BaseDirectory;
