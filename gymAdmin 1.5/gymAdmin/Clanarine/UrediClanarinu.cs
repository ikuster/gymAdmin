...
namespace gymAdmin
{
    public partial class UrediClanarinu : Form
    {
        ...
        private void UrediClanarinu_HelpRequested(object sender, HelpEventArgs hlpevent)
        {
            string RunningPath = AppDomain.CurrentDomain.BaseDirectory;
            string FileName = string.Format("{0}Resources\\helpUrediClanarinu.html", Path.GetFullPath(Path.Combine(RunningPath, @"..\..\")));
