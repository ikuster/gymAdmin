...
namespace gymAdmin
{
    public partial class NovaClanarina : Form
    {
        ...
        private void NovaClanarina_HelpRequested(object sender, HelpEventArgs hlpevent)
        {
            string RunningPath = AppDomain.CurrentDomain.BaseDirectory;
            string FileName = string.Format("{0}Resources\\helpNovaClanarina.html", Path.GetFullPath(Path.Combine(RunningPath, @"..\..\")));
